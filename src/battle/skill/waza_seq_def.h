...
//プラチナで追加
	DEF_CMD	WS_WAIT_NO_SKIP
	DEF_CMD	WS_WAZA_TYPE_CHECK
	DEF_CMD	WS_PERSONAL_DATA_GET
	DEF_CMD	WS_POKEPARA_RELOAD
...
//=============================================================================
/**
 *	指定分WAIT（キーによるスキップなしで、指定した分だけ必ず待つ）
 *
 *	@param	wait	WAIT_TIME（１につき、1/30秒）
 */
//=============================================================================
	.macro	WAIT_NO_SKIP	wait
	.long	WS_WAIT_NO_SKIP
	.long	\wait
	.endm

//=============================================================================
/**
 *	技タイプチェック(sp->waza_no_nowのタイプをチェックして、一致したらとび先へ）
 *
 *	@param	type	チェックする技タイプ
 *	@param	adrs	一致した時のとび先
 */
//=============================================================================
	.macro	WAZA_TYPE_CHECK	type,adrs
	.long	WS_WAZA_TYPE_CHECK
	.long	\type
	.long	(\adrs-.)/4-1
	.endm
 ...
 *	パーソナルデータ取得
 *
 *	@param	mons_no	取得するポケモンナンバー
 *	@param	form_no	フォルムナンバーが格納された領域へのインデックス
 *	@param	para	取得するパーソナルデータ
 *
 *	calc_workに取得するパーソナルデータが格納される
 */
//=============================================================================
	.macro	PERSONAL_DATA_GET	mons_no,form_no,para
	.long	WS_PERSONAL_DATA_GET
	.long	\mons_no
	.long	\form_no
	.long	\para
	.endm
 ...
 *	ポケモンパラメータをリロード
 *
 *	@param	side	リロードする側を指定
 */
//=============================================================================
	.macro	POKEPARA_RELOAD	side
	.long	WS_POKEPARA_RELOAD
	.long	\side
	.endm
