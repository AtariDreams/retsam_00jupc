...
u32 CheckCrossMatrix( Vec2DS32* vector1_s, Vec2DS32* vector1_e, Vec2DS32* vector2_s, Vec2DS32* vector2_e, Vec2DS32* cross )
{
	...
	Vec2DS32 vect1_max;				// ベクトル１の最大 範囲内かチェック用
	Vec2DS32 vect1_min;				// ベクトル１の最小 範囲内かチェック用
	Vec2DS32 vect2_max;				// ベクトル２の最大 範囲内かチェック用
	Vec2DS32 vect2_min;				// ベクトル２の最小 範囲内かチェック用
...
u32 CheckInOut( Vec2DS32* pData, u32 Size, u16 x, u16 y )
{
	int				i;					// ループ用	
	u32				check_num;			// 項点数
	Vec2DS32		main_s;				// チェック用ベクトル始点座標
	Vec2DS32		main_e;				// チェック用ベクトル終点座標
