 ...
 */
//--------------------------------------------------------------
void STRBUF_SetNumber64( STRBUF* dst, u64 number, u32 keta, NUMBER_DISPTYPE dispType, NUMBER_CODETYPE codeType )
{
	static const u64 n_max[] = 
	{
		1,
		10,
		100,
