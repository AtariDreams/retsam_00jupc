...
//p_get_effect.spa内のリソース個数
#define P_GET_EFFECT_SPAMAX	(5)

//p_get_01.hのsprリソース定義
...
//p_get_01.spa内のリソース個数
#define P_GET_01_SPAMAX	(5)

//p_get_02.hのsprリソース定義
...
//p_get_02.spa内のリソース個数
#define P_GET_02_SPAMAX	(5)

//p_get_03.hのsprリソース定義
...
//p_get_03.spa内のリソース個数
#define P_GET_03_SPAMAX	(5)

//p_get_04.hのsprリソース定義
...
//p_get_04.spa内のリソース個数
#define P_GET_04_SPAMAX	(5)

//p_get_05.hのsprリソース定義
...
//p_get_05.spa内のリソース個数
#define P_GET_05_SPAMAX	(5)

//p_get_06.hのsprリソース定義
...
//p_get_06.spa内のリソース個数
#define P_GET_06_SPAMAX	(6)

//p_get_07.hのsprリソース定義
...
//p_get_07.spa内のリソース個数
#define P_GET_07_SPAMAX	(5)

//p_get_08.hのsprリソース定義
...
//p_get_08.spa内のリソース個数
#define P_GET_08_SPAMAX	(5)

//p_get_09.hのsprリソース定義
...
//p_get_11.spa内のリソース個数
#define P_GET_11_SPAMAX	(6)

//p_get_12.hのsprリソース定義
...
//p_get_12.spa内のリソース個数
#define P_GET_12_SPAMAX	(5)

//p_get_13.hのsprリソース定義
...
//p_get_13.spa内のリソース個数
#define P_GET_13_SPAMAX	(5)

//p_get_14.hのsprリソース定義
...
//p_get_14.spa内のリソース個数
#define P_GET_14_SPAMAX	(5)

//p_get_15.hのsprリソース定義
...
//p_get_15.spa内のリソース個数
#define P_GET_15_SPAMAX	(6)

//p_get_16.hのsprリソース定義
...
//p_get_16.spa内のリソース個数
#define P_GET_16_SPAMAX	(6)

//p_get_17.hのsprリソース定義
...
//p_cb_hart01.hのsprリソース定義
#define P_CB_HART01_CB_HART01		0
//p_cb_hart01.spa内のリソース個数
#define P_CB_HART01_SPAMAX	(1)

//p_cb_hart02.hのsprリソース定義
#define P_CB_HART02_CB_HART02		0
//p_cb_hart02.spa内のリソース個数
#define P_CB_HART02_SPAMAX	(1)

//p_cb_hart03.hのsprリソース定義
#define P_CB_HART03_CB_HART03		0
//p_cb_hart03.spa内のリソース個数
#define P_CB_HART03_SPAMAX	(1)

//p_cb_hart04.hのsprリソース定義
#define P_CB_HART04_CB_HART04		0
//p_cb_hart04.spa内のリソース個数
#define P_CB_HART04_SPAMAX	(1)

//p_cb_hart05.hのsprリソース定義
#define P_CB_HART05_CB_HART05		0
//p_cb_hart05.spa内のリソース個数
#define P_CB_HART05_SPAMAX	(1)

//p_cb_hart06.hのsprリソース定義
#define P_CB_HART06_CB_HART06		0
//p_cb_hart06.spa内のリソース個数
#define P_CB_HART06_SPAMAX	(1)

//p_cb_star01.hのsprリソース定義
#define P_CB_STAR01_CB_STAR01		0
//p_cb_star01.spa内のリソース個数
#define P_CB_STAR01_SPAMAX	(1)

//p_cb_star02.hのsprリソース定義
#define P_CB_STAR02_CB_STAR02		0
//p_cb_star02.spa内のリソース個数
#define P_CB_STAR02_SPAMAX	(1)

//p_cb_star03.hのsprリソース定義
#define P_CB_STAR03_CB_STAR03		0
//p_cb_star03.spa内のリソース個数
#define P_CB_STAR03_SPAMAX	(1)

//p_cb_star04.hのsprリソース定義
#define P_CB_STAR04_CB_STAR04		0
//p_cb_star04.spa内のリソース個数
#define P_CB_STAR04_SPAMAX	(1)

//p_cb_star05.hのsprリソース定義
#define P_CB_STAR05_CB_STAR05		0
//p_cb_star05.spa内のリソース個数
#define P_CB_STAR05_SPAMAX	(1)

//p_cb_star06.hのsprリソース定義
#define P_CB_STAR06_CB_STAR06		0
//p_cb_star06.spa内のリソース個数
#define P_CB_STAR06_SPAMAX	(1)

//p_cb_line01.hのsprリソース定義
#define P_CB_LINE01_CB_LINE01		0
//p_cb_line01.spa内のリソース個数
#define P_CB_LINE01_SPAMAX	(1)

//p_cb_line02.hのsprリソース定義
#define P_CB_LINE02_CB_LINE02		0
//p_cb_line02.spa内のリソース個数
#define P_CB_LINE02_SPAMAX	(1)

//p_cb_line03.hのsprリソース定義
#define P_CB_LINE03_CB_LINE03		0
//p_cb_line03.spa内のリソース個数
#define P_CB_LINE03_SPAMAX	(1)

//p_cb_line04.hのsprリソース定義
#define P_CB_LINE04_CB_LINE04		0
//p_cb_line04.spa内のリソース個数
#define P_CB_LINE04_SPAMAX	(1)

//p_cb_tunder01.hのsprリソース定義
#define P_CB_TUNDER01_CB_TUNDER01		0
//p_cb_tunder01.spa内のリソース個数
#define P_CB_TUNDER01_SPAMAX	(1)

//p_cb_tunder02.hのsprリソース定義
#define P_CB_TUNDER02_CB_TUNDER02		0
//p_cb_tunder02.spa内のリソース個数
#define P_CB_TUNDER02_SPAMAX	(1)

//p_cb_tunder03.hのsprリソース定義
#define P_CB_TUNDER03_CB_TUNDER03		0
//p_cb_tunder03.spa内のリソース個数
#define P_CB_TUNDER03_SPAMAX	(1)

//p_cb_tunder04.hのsprリソース定義
#define P_CB_TUNDER04_CB_TUNDER04		0
//p_cb_tunder04.spa内のリソース個数
#define P_CB_TUNDER04_SPAMAX	(1)

//p_cb_kemuri01.hのsprリソース定義
#define P_CB_KEMURI01_CB_KEMURI01		0
//p_cb_kemuri01.spa内のリソース個数
#define P_CB_KEMURI01_SPAMAX	(1)

//p_cb_kemuri02.hのsprリソース定義
#define P_CB_KEMURI02_CB_KEMURI02		0
//p_cb_kemuri02.spa内のリソース個数
#define P_CB_KEMURI02_SPAMAX	(1)

//p_cb_kemuri03.hのsprリソース定義
#define P_CB_KEMURI03_CB_KEMURI03		0
//p_cb_kemuri03.spa内のリソース個数
#define P_CB_KEMURI03_SPAMAX	(1)

//p_cb_kemuri04.hのsprリソース定義
#define P_CB_KEMURI04_CB_KEMURI04		0
//p_cb_kemuri04.spa内のリソース個数
#define P_CB_KEMURI04_SPAMAX	(1)

//p_cb_ball01.hのsprリソース定義
#define P_CB_BALL01_CB_BALL01		0
//p_cb_ball01.spa内のリソース個数
#define P_CB_BALL01_SPAMAX	(1)

//p_cb_ball02.hのsprリソース定義
#define P_CB_BALL02_CB_BALL02		0
//p_cb_ball02.spa内のリソース個数
#define P_CB_BALL02_SPAMAX	(1)

//p_cb_ball03.hのsprリソース定義
#define P_CB_BALL03_CB_BALL03		0
//p_cb_ball03.spa内のリソース個数
#define P_CB_BALL03_SPAMAX	(1)

//p_cb_ball04.hのsprリソース定義
#define P_CB_BALL04_CB_BALL04		0
//p_cb_ball04.spa内のリソース個数
#define P_CB_BALL04_SPAMAX	(1)

//p_cb_fire01.hのsprリソース定義
#define P_CB_FIRE01_CB_FIRE01		0
//p_cb_fire01.spa内のリソース個数
#define P_CB_FIRE01_SPAMAX	(1)

//p_cb_fire02.hのsprリソース定義
#define P_CB_FIRE02_CB_FIRE02		0
//p_cb_fire02.spa内のリソース個数
#define P_CB_FIRE02_SPAMAX	(1)

//p_cb_fire03.hのsprリソース定義
#define P_CB_FIRE03_CB_FIRE03		0
//p_cb_fire03.spa内のリソース個数
#define P_CB_FIRE03_SPAMAX	(1)

//p_cb_fire04.hのsprリソース定義
#define P_CB_FIRE04_CB_FIRE04		0
//p_cb_fire04.spa内のリソース個数
#define P_CB_FIRE04_SPAMAX	(1)

//p_cb_paper01.hのsprリソース定義
#define P_CB_PAPER01_CB_PAPER01		0
//p_cb_paper01.spa内のリソース個数
#define P_CB_PAPER01_SPAMAX	(1)

//p_cb_paper02.hのsprリソース定義
#define P_CB_PAPER02_CB_PAPER02		0
//p_cb_paper02.spa内のリソース個数
#define P_CB_PAPER02_SPAMAX	(1)

//p_cb_paper03.hのsprリソース定義
#define P_CB_PAPER03_CB_PAPER03		0
//p_cb_paper03.spa内のリソース個数
#define P_CB_PAPER03_SPAMAX	(1)

//p_cb_paper04.hのsprリソース定義
#define P_CB_PAPER04_CB_PAPER04		0
//p_cb_paper04.spa内のリソース個数
#define P_CB_PAPER04_SPAMAX	(1)

//p_cb_hana01.hのsprリソース定義
#define P_CB_HANA01_CB_HANA01		0
//p_cb_hana01.spa内のリソース個数
#define P_CB_HANA01_SPAMAX	(1)

//p_cb_hana02.hのsprリソース定義
#define P_CB_HANA02_CB_HANA02		0
//p_cb_hana02.spa内のリソース個数
#define P_CB_HANA02_SPAMAX	(1)

//p_cb_hana03.hのsprリソース定義
#define P_CB_HANA03_CB_HANA03		0
//p_cb_hana03.spa内のリソース個数
#define P_CB_HANA03_SPAMAX	(1)

//p_cb_hana04.hのsprリソース定義
#define P_CB_HANA04_CB_HANA04		0
//p_cb_hana04.spa内のリソース個数
#define P_CB_HANA04_SPAMAX	(1)

//p_cb_hana05.hのsprリソース定義
#define P_CB_HANA05_CB_HANA05		0
//p_cb_hana05.spa内のリソース個数
#define P_CB_HANA05_SPAMAX	(1)

//p_cb_hana06.hのsprリソース定義
#define P_CB_HANA06_CB_HANA06		0
//p_cb_hana06.spa内のリソース個数
#define P_CB_HANA06_SPAMAX	(1)

//p_cb_onpu01.hのsprリソース定義
#define P_CB_ONPU01_CB_ONPU01		0
//p_cb_onpu01.spa内のリソース個数
#define P_CB_ONPU01_SPAMAX	(1)

//p_cb_onpu02.hのsprリソース定義
#define P_CB_ONPU02_CB_ONPU02		0
//p_cb_onpu02.spa内のリソース個数
#define P_CB_ONPU02_SPAMAX	(1)

//p_cb_onpu03.hのsprリソース定義
#define P_CB_ONPU03_CB_ONPU03		0
//p_cb_onpu03.spa内のリソース個数
#define P_CB_ONPU03_SPAMAX	(1)

//p_cb_onpu04.hのsprリソース定義
#define P_CB_ONPU04_CB_ONPU04		0
//p_cb_onpu04.spa内のリソース個数
#define P_CB_ONPU04_SPAMAX	(1)

//p_cb_onpu05.hのsprリソース定義
#define P_CB_ONPU05_CB_ONPU05		0
//p_cb_onpu05.spa内のリソース個数
#define P_CB_ONPU05_SPAMAX	(1)

//p_cb_onpu06.hのsprリソース定義
#define P_CB_ONPU06_CB_ONPU06		0
//p_cb_onpu06.spa内のリソース個数
#define P_CB_ONPU06_SPAMAX	(1)

//p_cb_onpu07.hのsprリソース定義
#define P_CB_ONPU07_CB_ONPU07		0
//p_cb_onpu07.spa内のリソース個数
#define P_CB_ONPU07_SPAMAX	(1)

//p_cb_alpha_a.hのsprリソース定義
#define P_CB_ALPHA_A_CB_ALPHA_A		0
//p_cb_alpha_a.spa内のリソース個数
#define P_CB_ALPHA_A_SPAMAX	(1)

//p_cb_alpha_b.hのsprリソース定義
#define P_CB_ALPHA_B_CB_ALPHA_B		0
//p_cb_alpha_b.spa内のリソース個数
#define P_CB_ALPHA_B_SPAMAX	(1)

//p_cb_alpha_c.hのsprリソース定義
#define P_CB_ALPHA_C_CB_ALPHA_C		0
//p_cb_alpha_c.spa内のリソース個数
#define P_CB_ALPHA_C_SPAMAX	(1)

//p_cb_alpha_d.hのsprリソース定義
#define P_CB_ALPHA_D_CB_ALPHA_D		0
//p_cb_alpha_d.spa内のリソース個数
#define P_CB_ALPHA_D_SPAMAX	(1)

//p_cb_alpha_e.hのsprリソース定義
#define P_CB_ALPHA_E_CB_ALPHA_E		0
//p_cb_alpha_e.spa内のリソース個数
#define P_CB_ALPHA_E_SPAMAX	(1)

//p_cb_alpha_f.hのsprリソース定義
#define P_CB_ALPHA_F_CB_ALPHA_F		0
//p_cb_alpha_f.spa内のリソース個数
#define P_CB_ALPHA_F_SPAMAX	(1)

//p_cb_alpha_g.hのsprリソース定義
#define P_CB_ALPHA_G_CB_ALPHA_G		0
//p_cb_alpha_g.spa内のリソース個数
#define P_CB_ALPHA_G_SPAMAX	(1)

//p_cb_alpha_h.hのsprリソース定義
#define P_CB_ALPHA_H_CB_ALPHA_H		0
//p_cb_alpha_h.spa内のリソース個数
#define P_CB_ALPHA_H_SPAMAX	(1)

//p_cb_alpha_i.hのsprリソース定義
#define P_CB_ALPHA_I_CB_ALPHA_I		0
//p_cb_alpha_i.spa内のリソース個数
#define P_CB_ALPHA_I_SPAMAX	(1)

//p_cb_alpha_j.hのsprリソース定義
#define P_CB_ALPHA_J_CB_ALPHA_J		0
//p_cb_alpha_j.spa内のリソース個数
#define P_CB_ALPHA_J_SPAMAX	(1)

//p_cb_alpha_k.hのsprリソース定義
#define P_CB_ALPHA_K_CB_ALPHA_K		0
//p_cb_alpha_k.spa内のリソース個数
#define P_CB_ALPHA_K_SPAMAX	(1)

//p_cb_alpha_l.hのsprリソース定義
#define P_CB_ALPHA_L_CB_ALPHA_L		0
//p_cb_alpha_l.spa内のリソース個数
#define P_CB_ALPHA_L_SPAMAX	(1)

//p_cb_alpha_m.hのsprリソース定義
#define P_CB_ALPHA_M_CB_ALPHA_M		0
//p_cb_alpha_m.spa内のリソース個数
#define P_CB_ALPHA_M_SPAMAX	(1)

//p_cb_alpha_n.hのsprリソース定義
#define P_CB_ALPHA_N_CB_ALPHA_N		0
//p_cb_alpha_n.spa内のリソース個数
#define P_CB_ALPHA_N_SPAMAX	(1)

//p_cb_alpha_o.hのsprリソース定義
#define P_CB_ALPHA_O_CB_ALPHA_O		0
//p_cb_alpha_o.spa内のリソース個数
#define P_CB_ALPHA_O_SPAMAX	(1)

//p_cb_alpha_p.hのsprリソース定義
#define P_CB_ALPHA_P_CB_ALPHA_P		0
//p_cb_alpha_p.spa内のリソース個数
#define P_CB_ALPHA_P_SPAMAX	(1)

//p_cb_alpha_q.hのsprリソース定義
#define P_CB_ALPHA_Q_CB_ALPHA_Q		0
//p_cb_alpha_q.spa内のリソース個数
#define P_CB_ALPHA_Q_SPAMAX	(1)

//p_cb_alpha_r.hのsprリソース定義
#define P_CB_ALPHA_R_CB_ALPHA_R		0
//p_cb_alpha_r.spa内のリソース個数
#define P_CB_ALPHA_R_SPAMAX	(1)

//p_cb_alpha_s.hのsprリソース定義
#define P_CB_ALPHA_S_CB_ALPHA_S		0
//p_cb_alpha_s.spa内のリソース個数
#define P_CB_ALPHA_S_SPAMAX	(1)

//p_cb_alpha_t.hのsprリソース定義
#define P_CB_ALPHA_T_CB_ALPHA_T		0
//p_cb_alpha_t.spa内のリソース個数
#define P_CB_ALPHA_T_SPAMAX	(1)

//p_cb_alpha_u.hのsprリソース定義
#define P_CB_ALPHA_U_CB_ALPHA_U		0
//p_cb_alpha_u.spa内のリソース個数
#define P_CB_ALPHA_U_SPAMAX	(1)

//p_cb_alpha_v.hのsprリソース定義
#define P_CB_ALPHA_V_CB_ALPHA_V		0
//p_cb_alpha_v.spa内のリソース個数
#define P_CB_ALPHA_V_SPAMAX	(1)

//p_cb_alpha_w.hのsprリソース定義
#define P_CB_ALPHA_W_CB_ALPHA_W		0
//p_cb_alpha_w.spa内のリソース個数
#define P_CB_ALPHA_W_SPAMAX	(1)

//p_cb_alpha_x.hのsprリソース定義
#define P_CB_ALPHA_X_CB_ALPHA_X		0
//p_cb_alpha_x.spa内のリソース個数
#define P_CB_ALPHA_X_SPAMAX	(1)

//p_cb_alpha_y.hのsprリソース定義
#define P_CB_ALPHA_Y_CB_ALPHA_Y		0
//p_cb_alpha_y.spa内のリソース個数
#define P_CB_ALPHA_Y_SPAMAX	(1)

//p_cb_alpha_z.hのsprリソース定義
#define P_CB_ALPHA_Z_CB_ALPHA_Z		0
//p_cb_alpha_z.spa内のリソース個数
#define P_CB_ALPHA_Z_SPAMAX	(1)

//p_cb_alpha_mark01.hのsprリソース定義
#define P_CB_ALPHA_MARK01_CB_ALPHA_MARK01		0
//p_cb_alpha_mark01.spa内のリソース個数
#define P_CB_ALPHA_MARK01_SPAMAX	(1)

//p_cb_alpha_mark02.hのsprリソース定義
#define P_CB_ALPHA_MARK02_CB_ALPHA_MARK02		0
//p_cb_alpha_mark02.spa内のリソース個数
#define P_CB_ALPHA_MARK02_SPAMAX	(1)

//p_cb_sp_01.hのsprリソース定義
#define P_CB_SP_01_CB_WATER		0
//p_cb_sp_01.spa内のリソース個数
#define P_CB_SP_01_SPAMAX	(1)

//p_cb_sp_02.hのsprリソース定義
#define P_CB_SP_02_CB_BOMB		0
//p_cb_sp_02.spa内のリソース個数
#define P_CB_SP_02_SPAMAX	(1)

//p_cb_sp_03.hのsprリソース定義
#define P_CB_SP_03_CB_KIRAKIRA		0
//p_cb_sp_03.spa内のリソース個数
#define P_CB_SP_03_SPAMAX	(1)



//---- ball_effect_setup_tblテーブルのdefine定義 ----
#define SPA_P_BALL_EFFECT		(0)
#define SPA_P_BALL_01		(1)
#define SPA_P_BALL_02		(2)
#define SPA_P_BALL_03		(3)
#define SPA_P_BALL_04		(4)
#define SPA_P_BALL_05		(5)
#define SPA_P_BALL_06		(6)
#define SPA_P_BALL_07		(7)
#define SPA_P_BALL_08		(8)
#define SPA_P_BALL_09		(9)
#define SPA_P_BALL_10		(10)
#define SPA_P_BALL_11		(11)
#define SPA_P_BALL_12		(12)
#define SPA_P_BALL_13		(13)
#define SPA_P_BALL_14		(14)
#define SPA_P_BALL_15		(15)
#define SPA_P_BALL_16		(16)
#define SPA_P_BALL_17		(17)
#define SPA_P_GET_EFFECT		(18)
#define SPA_P_GET_01		(19)
#define SPA_P_GET_02		(20)
#define SPA_P_GET_03		(21)
#define SPA_P_GET_04		(22)
#define SPA_P_GET_05		(23)
#define SPA_P_GET_06		(24)
#define SPA_P_GET_07		(25)
#define SPA_P_GET_08		(26)
#define SPA_P_GET_09		(27)
#define SPA_P_GET_10		(28)
#define SPA_P_GET_11		(29)
#define SPA_P_GET_12		(30)
#define SPA_P_GET_13		(31)
#define SPA_P_GET_14		(32)
#define SPA_P_GET_15		(33)
#define SPA_P_GET_16		(34)
#define SPA_P_GET_17		(35)
#define SPA_P_BACK		(36)
#define SPA_P_CB_HART01		(37)
#define SPA_P_CB_HART02		(38)
#define SPA_P_CB_HART03		(39)
#define SPA_P_CB_HART04		(40)
#define SPA_P_CB_HART05		(41)
#define SPA_P_CB_HART06		(42)
#define SPA_P_CB_STAR01		(43)
#define SPA_P_CB_STAR02		(44)
#define SPA_P_CB_STAR03		(45)
#define SPA_P_CB_STAR04		(46)
#define SPA_P_CB_STAR05		(47)
#define SPA_P_CB_STAR06		(48)
#define SPA_P_CB_LINE01		(49)
#define SPA_P_CB_LINE02		(50)
#define SPA_P_CB_LINE03		(51)
#define SPA_P_CB_LINE04		(52)
#define SPA_P_CB_TUNDER01		(53)
#define SPA_P_CB_TUNDER02		(54)
#define SPA_P_CB_TUNDER03		(55)
#define SPA_P_CB_TUNDER04		(56)
#define SPA_P_CB_KEMURI01		(57)
#define SPA_P_CB_KEMURI02		(58)
#define SPA_P_CB_KEMURI03		(59)
#define SPA_P_CB_KEMURI04		(60)
#define SPA_P_CB_BALL01		(61)
#define SPA_P_CB_BALL02		(62)
#define SPA_P_CB_BALL03		(63)
#define SPA_P_CB_BALL04		(64)
#define SPA_P_CB_FIRE01		(65)
#define SPA_P_CB_FIRE02		(66)
#define SPA_P_CB_FIRE03		(67)
#define SPA_P_CB_FIRE04		(68)
#define SPA_P_CB_PAPER01		(69)
#define SPA_P_CB_PAPER02		(70)
#define SPA_P_CB_PAPER03		(71)
#define SPA_P_CB_PAPER04		(72)
#define SPA_P_CB_HANA01		(73)
#define SPA_P_CB_HANA02		(74)
#define SPA_P_CB_HANA03		(75)
#define SPA_P_CB_HANA04		(76)
#define SPA_P_CB_HANA05		(77)
#define SPA_P_CB_HANA06		(78)
#define SPA_P_CB_ONPU01		(79)
#define SPA_P_CB_ONPU02		(80)
#define SPA_P_CB_ONPU03		(81)
#define SPA_P_CB_ONPU04		(82)
#define SPA_P_CB_ONPU05		(83)
#define SPA_P_CB_ONPU06		(84)
#define SPA_P_CB_ONPU07		(85)
#define SPA_P_CB_ALPHA_A		(86)
#define SPA_P_CB_ALPHA_B		(87)
#define SPA_P_CB_ALPHA_C		(88)
#define SPA_P_CB_ALPHA_D		(89)
#define SPA_P_CB_ALPHA_E		(90)
#define SPA_P_CB_ALPHA_F		(91)
#define SPA_P_CB_ALPHA_G		(92)
#define SPA_P_CB_ALPHA_H		(93)
#define SPA_P_CB_ALPHA_I		(94)
#define SPA_P_CB_ALPHA_J		(95)
#define SPA_P_CB_ALPHA_K		(96)
#define SPA_P_CB_ALPHA_L		(97)
#define SPA_P_CB_ALPHA_M		(98)
#define SPA_P_CB_ALPHA_N		(99)
#define SPA_P_CB_ALPHA_O		(100)
#define SPA_P_CB_ALPHA_P		(101)
#define SPA_P_CB_ALPHA_Q		(102)
#define SPA_P_CB_ALPHA_R		(103)
#define SPA_P_CB_ALPHA_S		(104)
#define SPA_P_CB_ALPHA_T		(105)
#define SPA_P_CB_ALPHA_U		(106)
#define SPA_P_CB_ALPHA_V		(107)
#define SPA_P_CB_ALPHA_W		(108)
#define SPA_P_CB_ALPHA_X		(109)
#define SPA_P_CB_ALPHA_Y		(110)
#define SPA_P_CB_ALPHA_Z		(111)
#define SPA_P_CB_ALPHA_MARK01		(112)
#define SPA_P_CB_ALPHA_MARK02		(113)
#define SPA_P_CB_SP_01		(114)
#define SPA_P_CB_SP_02		(115)
#define SPA_P_CB_SP_03		(116)

#define SPA_BALL_EFFECT_SETUP_MAX		(117)
