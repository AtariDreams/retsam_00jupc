...
struct WORLDTRADE_DATA{
	...
	GF_DATE		lastExchangeDate_Deposit;		// 最終交換日付(預けて成立した日付)
	GF_DATE		lastExchangeDate_Search;		// 最終交換日付(検索して成立した日付)
};
 ...
 */
//==============================================================================
void  WorldTradeData_SetLastDate_Deposit( WORLDTRADE_DATA* WorldTradeData, GF_DATE date )
{
 ...
 */
//==============================================================================
void  WorldTradeData_SetLastDate_Search( WORLDTRADE_DATA* WorldTradeData, GF_DATE date )
{
