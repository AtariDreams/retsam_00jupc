...
typedef struct {
	...
	BOOL wipe_exist_s;	// ワイプが終了したらFALSEになってします	ワイプ終了したかチェック用
...
//----------------------------------------------------------------------------
/**
 *	@brief	フェードアウトでウィンドウ設定時に白黒のときは、マスターブライトネスにする
 *
 *	@param	p_data	ワーク
 *
 *	@return	none
