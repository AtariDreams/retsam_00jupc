...
///< HANDLE	
extern BOOL CATS_LoadResourceCharArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int trans_mode, int id);
extern s8	CATS_LoadResourcePlttArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int num, int trans_mode, int id);
extern BOOL CATS_LoadResourceCellArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int id);
extern BOOL CATS_LoadResourceCellAnmArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int id);
extern BOOL CATS_LoadResourceMCellArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int id);
extern BOOL CATS_LoadResourceMCellAnmArcH(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* arcHandle, int data_id, int comp, int id);
extern u8 CATS_LoadResourcePlttWorkArcH(PALETTE_FADE_PTR pfd, FADEREQ req, CATS_SYS_PTR csp, 
...
extern void CATS_ObjectUpdateCapEx( CATS_ACT_PTR cap );
...
extern void CATS_ObjectAnimeSeqCheckSetCap( CATS_ACT_PTR cap, u32 seq );
...
extern void CATS_ObjectPosMoveCapFx32(CATS_ACT_PTR cap, fx32 x, fx32 y);

extern void CATS_ObjectPosSetCapFx32(CATS_ACT_PTR cap, fx32 x, fx32 y);
extern void CATS_ObjectPosGetCapFx32(CATS_ACT_PTR cap, fx32* x, fx32* y);
extern void CATS_ObjectPosSetCapFx32_SubSurface(CATS_ACT_PTR cap, fx32 x, fx32 y, fx32 sub_surface_y);
extern void CATS_ObjectPosGetCapFx32_SubSurface(CATS_ACT_PTR cap, fx32* x, fx32* y, fx32 sub_surface_y);
...
// -----------------------------------------
//
//	■アニメーションシーケンス拡張アトリビュート取得
//
// -----------------------------------------
extern u32 CATS_ObjectUserAttrAnimSeqGet( CATS_ACT_PTR cap, u32 seqidx );
extern u32 CATS_ObjectUserAttrNowAnimSeqGet( CATS_ACT_PTR cap );

// -----------------------------------------
//
//	■アニメーションフレーム拡張アトリビュート取得
//
// -----------------------------------------
extern u32 CATS_ObjectUserAttrAnimFrameGet( CATS_ACT_PTR cap, u32 seqidx, u32 frameidx );
extern u32 CATS_ObjectUserAttrNowAnimFrameGet( CATS_ACT_PTR cap );
...
extern BOOL CATS_LoadResourceCharArcModeAdjustAreaCont(
				CATS_SYS_PTR csp, CATS_RES_PTR crp, int arc_id, int data_id, BOOL comp, int trans_mode, int id);
extern BOOL CATS_LoadResourceCharArcModeAdjustAreaCont_Handle(
...
extern void CATS_ChangeResourcePlttArcH(
				CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE* p_handle, int data_id, BOOL comp, int id );
extern void CATS_ChangeResourcePlttArcH_PlttWork( 
