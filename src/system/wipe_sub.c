...
//=====================================
typedef struct {
	WIPE_WND_POSITION_FP st;	// 開始座標
	WIPE_WND_POSITION_FP ed;	// 終了座標
...
//=====================================
typedef struct {
	const WIPE_WND_POSITION_FP* p_st;	// 分割した各々の開始座標	優先順位（０＞ｎ）
	const WIPE_WND_POSITION_FP* p_ed;	// 分割した各々の終了座標
	u16 divi_num;				// 分割数
	u16 wnd_no;
	u8 in_wnd;
	u8 out_wnd;
...
typedef struct {
	u8 s_y;		
	u8 e_y;
	u16 in_out;		// WIPE_WND_VMOVE_INWND, WIPE_WND_VMOVE_OUTWND
...
static void sum_set_wnd_position(WIPE_WND_POSITION* st, WIPE_WND_POSITION* ed, WIPE_WND_POSITION* add, const WIPE_WND_POSITION_FP* set_st, const WIPE_WND_POSITION_FP* set_ed, int division );
...
{
	if(wipe->sequence == WIPE_INIT){
		static const WIPE_WND_POSITION_FP st[] = {
			{0,0,255,48},
			{0,47,255,96},
			{0,96,255,144},
			{0,144,255,192}
		};
		static const WIPE_WND_POSITION_FP ed[] = {
			{0,0,0,48},
			{255,47,255,96},
			{0,96,0,144},
			{255,144,255,192}
