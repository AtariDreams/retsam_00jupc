...
extern void DT_MusicBarAnimeUpdate(DANCE_SYSTEM_PARAM *sys, int len, int rhythm_no);
extern void DT_MusicBarAnimeUpdateFrame(
	DANCE_SYSTEM_PARAM *sys, int now_frame, int end_frame, int rhythm_no);
extern void DT_OnpuResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
extern void DT_OnpuResourceFree(CATS_RES_PTR crp);
extern void DT_OnpuActorDelAll(DANCE_SYSTEM_PARAM *sys);
extern void DT_ReviewPanelResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void DT_MyCursorResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void DT_PrinResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void PrinReq_FrameUpdate(PRIN_WORK *pw, u32 now_frame, u32 end_frame, int rhythm_no);
extern void PrinReq_OutMove(PRIN_WORK *pw);
extern void PrinReq_InMove(PRIN_WORK *pw, int rhythm_no);
...
extern s64 DT_DancingStartFrameCheck(DANCE_PROC_WORK *dpw, const DANCE_MUSIC_DATA *musicdata, 
	int now_count);
extern void DT_ShadowResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void DT_SpotLightResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void DT_StarResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
...
extern void DT_MusicLineResourceLoad(CATS_SYS_PTR csp, CATS_RES_PTR crp, ARCHANDLE *hdl_obj);
extern void DT_MusicLineResourceFree(CATS_RES_PTR crp);
extern BOOL DT_MusicLineActorSet(DANCE_PROC_WORK *dpw);
extern void DT_MusicLineActorDelete(DANCE_PROC_WORK *dpw);
extern void DT_MusicLineUpdateFrame(MUSLINE_WORK *musline, 
	u32 now_frame, u32 end_frame, int rhythm_no);
extern void DT_MusicLineEnableSet(MUSLINE_WORK *musline, int enable);
