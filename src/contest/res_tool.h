...
extern void RT_ConfettiResouceLoad(CONRES_PROC_WORK *rpw, ARCHANDLE *hdl_obj);
extern void RT_ConfettiResouceFree(CONRES_PROC_WORK *rpw);
extern void RT_RankingIconSetAll(CONRES_PROC_WORK *rpw, ARCHANDLE *hdl_obj);
...
extern void RT_MeterResouceLoad(CONRES_PROC_WORK *rpw, ARCHANDLE *hdl_obj);
