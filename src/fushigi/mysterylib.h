...
#define MYSTERYLIB_CHAR_CONT_NUM		( 40 )	///20
#define MYSTERYLIB_CHAR_VRAMTRANS_MAIN_SIZE	( 4096 )	///< 2048
#define MYSTERYLIB_CHAR_VRAMTRANS_SUB_SIZE	( 4096 )	///< 2048
#define MYSTERYLIB_PLTT_CONT_NUM		30
...
extern MYSTERY_CLACT* MysteryLib_GetClactSystem( void );
...
extern void MysteryLib_DoClact_Ex( int state );
