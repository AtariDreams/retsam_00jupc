 ...
 */
//--------------------------------------------------------------------------------------------
static void CreateWindowMenuData(MYSTERYCARD_WORK *wk, LISTDATA *ld, int num, GF_BGL_BMPWIN *win, int curpos)
{
  int i;
  ...
  list_h.count = num;
  list_h.win = win;
  wk->lw = BmpListSet( &list_h, 0, curpos, HEAPID_MYSTERYCARD);
}
...
static BOOL MysteryCardMenu2Win(MYSTERYCARD_WORK *wk, GF_BGL_BMPWIN *win, GF_PRINTCOLOR col)
{
  CreateWindowMenuData(wk, MysteryCard_Menu2Data, 2, win, 1);
  return TRUE;
}
...
static BOOL MysteryCardMenu3Win(MYSTERYCARD_WORK *wk, GF_BGL_BMPWIN *win, GF_PRINTCOLOR col)
{
  CreateWindowMenuData(wk, MysteryCard_Menu3Data, 2, win, 0);
  return TRUE;
}
...
static BOOL MysteryCardMenu4Win(MYSTERYCARD_WORK *wk, GF_BGL_BMPWIN *win, GF_PRINTCOLOR col)
{
  ...
  CreateWindowMenuData(wk, MysteryCard_Menu4Data, 2, win, 0);
  return TRUE;
}
...
static void MysteryCard_StartSaveSeq(MYSTERYCARD_WORK *wk)
{
    ...
    GF_ASSERT(wk->disp_card <GIFT_CARD_MAX); 
