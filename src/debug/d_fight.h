...
#define	CREATE_HEAP_SIZE	(0x30000)	//CreateHeapSize
...
#define	MINE_CUR_X			(12)			//じぶんカーソル表示X座標
#define	MINE_CUR_Y			(8)				//じぶんカーソル表示Y座標

#define	ENEMY_CUR_X			(140)			//あいてカーソル表示X座標
#define	ENEMY_CUR_Y			(8)				//あいてカーソル表示Y座標
...
#define	ORDER_X				(MENU3_LIST_X)
#define	ORDER_Y				(MENU3_LIST_Y+MENU3_LIST_OFS*2)
#define	ORDER_DATA_X		(MENU3_LIST_X)
#define	ORDER_DATA_Y		(MENU3_LIST_Y+MENU3_LIST_OFS*2)
#define	ORDER_CUR_X			(ORDER_X-12)
#define	ORDER_CUR_Y			(ORDER_Y)
...
enum{
	...
	SEQ_AUTO_FLAG_INIT,
	SEQ_AUTO_FLAG_MAIN,
	SEQ_REC_DATA_EDIT_INIT,
	SEQ_REC_DATA_EDIT_MAIN,
	SEQ_REC_DATA_EDIT_MAIN2,
	SEQ_REC_DATA_EDIT_DATA,
	SEQ_COM_SELECT_EDIT_INIT,
	SEQ_COM_SELECT_EDIT_MAIN,
	SEQ_COM_SELECT_EDIT_DATA,
};
...
#define	TRAINER_ID_Y_TOP		(72)

#define	TRAINER1_ID_X			(24)
#define	TRAINER1_ID_Y			(TRAINER_ID_Y_TOP+ 0)
#define	TRAINER1_ID_DATA_X		(64)
#define	TRAINER1_ID_DATA_Y		(TRAINER_ID_Y_TOP+ 0)
#define	TRAINER2_ID_X			(24)
#define	TRAINER2_ID_Y			(TRAINER_ID_Y_TOP+16)
#define	TRAINER2_ID_DATA_X		(64)
#define	TRAINER2_ID_DATA_Y		(TRAINER_ID_Y_TOP+16)
#define	BT_TRAINER1_ID_X		(24)
#define	BT_TRAINER1_ID_Y		(TRAINER_ID_Y_TOP+32)
#define	BT_TRAINER1_ID_DATA_X	(64)
#define	BT_TRAINER1_ID_DATA_Y	(TRAINER_ID_Y_TOP+32)
#define	BT_TRAINER2_ID_X		(24)
#define	BT_TRAINER2_ID_Y		(TRAINER_ID_Y_TOP+48)
#define	BT_TRAINER2_ID_DATA_X	(64)
#define	BT_TRAINER2_ID_DATA_Y	(TRAINER_ID_Y_TOP+48)
...
#define	AUTO_BATTLE			(0x0c)
#define	AUTO_BATTLE_WAIT	(30*3)
...
extern	DEBUG_POKEMON_PARAM	*DebugFightDPPGet(DEBUG_FIGHT_PARAM *dfp,int mine,int enemy,int pos);
...
extern	void	DebugFightDefaultPokeSet(DEBUG_FIGHT_PARAM *dfp,DEBUG_POKEMON_PARAM *dpp);
extern	void	DebugFightAIScreenCreate(DEBUG_FIGHT_PARAM *dfp);
extern	void	DebugFightAutoScreenCreate(DEBUG_FIGHT_PARAM *dfp);
extern	void	DebugFightRecDataEditScreenCreate(DEBUG_FIGHT_PARAM *dfp);
extern	void	DebugFightRecDataEdit2ScreenCreate(DEBUG_FIGHT_PARAM *dfp,GF_PRINTCOLOR col);
extern	void	DebugFightComSelectEditScreenCreate(DEBUG_FIGHT_PARAM *dfp,GF_PRINTCOLOR col);
...
extern	BOOL	DebugFightBRDSaveAct(DEBUG_FIGHT_PARAM *dfp,DEBUG_POKEMON_PARAM *dpp);
extern	void	DebugFightBRDSaveActMain(DEBUG_FIGHT_PARAM *dfp);
...
extern	int		DebugFightCommandBufferGet(void);
