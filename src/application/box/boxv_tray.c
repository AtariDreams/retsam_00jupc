...
static const struct {
	...
	{ NARC_box_pl_wpex04_lz_nscr, NARC_box_pl_wpex04_lz_ncgr, NARC_box_pl_wpex04_nclr },
	{ NARC_box_pl_wpex05_lz_nscr, NARC_box_pl_wpex05_lz_ncgr, NARC_box_pl_wpex05_nclr },
	{ NARC_box_pl_wpex06_lz_nscr, NARC_box_pl_wpex06_lz_ncgr, NARC_box_pl_wpex06_nclr },
	{ NARC_box_pl_wpex07_lz_nscr, NARC_box_pl_wpex07_lz_ncgr, NARC_box_pl_wpex07_nclr },
	{ NARC_box_pl_wpex08_lz_nscr, NARC_box_pl_wpex08_lz_ncgr, NARC_box_pl_wpex08_nclr },
 ...
 * @param   completeFlag	TRUEだとパレットデータのVRAM転送，アイコン作成まで行う。FALSEだと両方やらない
 *
 */
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------
/**
 * 壁紙パレットデータを読み込み、フェード用の加工をしてワークに保存。必要あればVram転送も行う
 *
 * @param   wk				ワークポインタ
...
//	VParaSet_StatusPoke( vpara, ppp, wk );
	BoxAppView_TrayIconUpdateGraphic( wk, pos );
}
//------------------------------------------------------------------------------
/**
 ...
 */
//------------------------------------------------------------------
void BoxAppView_TrayIconUpdateGraphic( TRAY_VIEW_WORK* wk, u32 pos )
{
	if( wk->icon[wk->imgPos][pos].act != NULL )
	{
		BoxAppView_PokeIconRewrite_VramTrans(wk->iconSys, &(wk->icon[wk->imgPos][pos]), TRUE);
