...
extern BOOL BoxAppView_IconSysInit( BOX_ICON_SYS* iconSys, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, CLACT_SET_PTR actsys, ARCHANDLE* p_boxgra_handle );
...
extern void BoxAppView_TrayIconUpdateGraphic( TRAY_VIEW_WORK* wk, u32 pos );
...
extern BOOL BoxAppView_PartyInit( PARTY_VIEW_WORK* wk, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, GF_BGL_INI* bgl, CLACT_SET_PTR actsys, ARCHANDLE* p_boxgra_handle );
...
extern BOOL BoxAppView_CursorInit( CURSOR_VIEW_WORK* wk, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, CLACT_SET_PTR actsys, ARCHANDLE* p_boxgra_handle );
extern void BoxAppView_CursorActSet( CURSOR_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle );
...
extern BOX_ICON_WORK * BoxAppView_CursorCatchIconPtrGet( CURSOR_VIEW_WORK* wk, int pos );
...
extern BOOL BoxAppView_ButtonInit( BUTTON_VIEW_WORK* wk, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, CLACT_SET_PTR actsys, ARCHANDLE* p_boxgra_handle );
extern void BoxAppView_ButtonActSet( BUTTON_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle );
...
extern BOOL BoxAppView_StatusInit( STATUS_VIEW_WORK* wk, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, GF_BGL_INI* bgl, CLACT_SET_PTR actsys, const MSGDATA_MANAGER* msgman, ARCHANDLE* p_boxgra_handle );
...
extern BOOL BoxAppView_ExWinInit( EXWIN_VIEW_WORK* wk, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, GF_BGL_INI* bgl, CLACT_SET_PTR actsys, ARCHANDLE* p_boxgra_handle );
...
extern void BoxAppView_Reel_Setup( REEL_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle );
...
extern BOOL BoxAppView_CompareInit( COMPARE_VIEW_WORK** wk_ptr_adrs, BOXAPP_VIEW_WORK* vwk, const BOXAPP_VPARAM* vpara, GF_BGL_INI* bgl, CLACT_SET_PTR actsys, MSGDATA_MANAGER* msgman, ARCHANDLE* p_boxgra_handle );
extern void BoxAppView_CompareQuit( COMPARE_VIEW_WORK* wk );
extern void BoxAppView_SetupCompare( COMPARE_VIEW_WORK* wk, ARCHANDLE* p_boxgra_handle );
