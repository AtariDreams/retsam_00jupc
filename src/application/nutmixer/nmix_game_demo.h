...
GLOBAL void NMixGameDemo_SubWin_GraphicLoad( NMIX_DEMO_SUB_WIN* p_work, GF_BGL_INI* p_bgl, u32 heapID, ARCHANDLE* p_handle );
...
GLOBAL void NMixGameDemo_NabeGra_GraphicLoad( NMIX_DEMO_NABE_GRA* p_work, SWSP_SYS_PTR	swsp_sys, u32 heapID, ARCHANDLE* p_handle );
...
GLOBAL void NMixGameDemo_MainWin_GraphicLoad( NMIX_DEMO_MAIN_WIN* p_work, GF_BGL_INI* p_bgl, u32 heapID, ARCHANDLE* p_handle );
...
GLOBAL void MMixGameDemo_StartTimeWait( NMIX_DEMO_MAIN_WIN* p_work );
GLOBAL void MMixGameDemo_EndTimeWait( NMIX_DEMO_MAIN_WIN* p_work );
...
GLOBAL void NMixGameDemo_Yazirusi_GraphicLoad( NMIX_DEMO_YAZIRUSI* p_work, NMIXGAME_CLACT_SYS* p_clact, u32 heapID, ARCHANDLE* p_handle );
