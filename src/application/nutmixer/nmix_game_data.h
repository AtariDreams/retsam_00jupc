...
//=====================================
typedef struct {
	u32 koge_count;			// こげカウンタ
	u32 kobosi_count;		// こぼしカウンタ
	// こげ
...
GLOBAL void NMIX_DATA_OyaCommDataMerge( NMIX_DATA_OYA* p_data, NUTMIX_GAME_COMM_PACK* p_comm_pack, int comm_count );
