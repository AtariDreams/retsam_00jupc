...
#define	BUTTON_CGX_SIZE		( 5 )		// 一辺のボタンサイズ
#define	BUTTON_CGX_WIDE		( 30 )		// グラフィックファイルのX幅

#define	BUTTON_CGX_XNEXT	( 15 )									// 次のボタンへのキャラサイズX
#define	BUTTON_CGX_YNEXT	( BUTTON_CGX_WIDE * BUTTON_CGX_SIZE )	// 次のボタンへのキャラサイズY
