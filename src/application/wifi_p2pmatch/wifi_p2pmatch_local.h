...
struct _WIFIP2PMATCH_WORK{
  ...
  int matchStatusBackup[WIFIP2PMATCH_MEMBER_MAX];// 友達ビーコンデータが変わったかチェック用
  int matchVchatBackup[WIFIP2PMATCH_MEMBER_MAX];// 友達ビーコンデータが変わったかチェック用
...
//*/
  ...
  u16 keepStatus;			// 接続しようとしたら相手のステータスが変わったときのチェック用
  u16 keepVChat;			// 接続しようとしたらボイスチャット状態が変わったときのチェック用
