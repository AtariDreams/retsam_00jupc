...
// スイッチの 0/1 で修正がオン／オフされるように変更した上で反映
...
//		GF_STR_PrintSimple(win, FONT_TALK, str_dest, 0, 0, 0, NULL);
...
//	GF_STR_PrintSimple(win, FONT_TALK, str_dest, 0, 0, 0, NULL);
	GF_STR_PrintColor(win, FONT_TALK, str_dest, SEAL_NUM_PRINT_X, SEAL_NUM_PRINT_Y,
					  MSG_NO_PUT, PRINT_COL_NUM, NULL);
