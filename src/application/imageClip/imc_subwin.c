...
#define IMC_SUBWIN_NUM_ONE_SYNC	( 30 )	// 1秒のカウンタ変更値
...
//----------------------------------------------------------------------------
/**
 *	@brief	カウンター用エフェクトの初期化
 *
 *	@param	p_data			カウンターワーク
 *	@param	effect_work		エフェクトワーク
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
