...
static void BagBgGraphicSet( BAG_WORK * wk )
{
	...
	ArcUtil_HDL_BgCharSet(
		wk->gra_h, NARC_bag_gra_bag_bg_NCGR, wk->bgl, GF_BGL_FRAME1_M, 0, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_ScrnSet(
		wk->gra_h, NARC_bag_gra_bag_bg1_NSCR, wk->bgl, GF_BGL_FRAME1_M, 0, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_ScrnSet(
		wk->gra_h, NARC_bag_gra_bag_bg0_NSCR, wk->bgl, GF_BGL_FRAME3_M, 0, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_PalSet(
	...
	ArcUtil_HDL_BgCharSet(
		wk->gra_h, NARC_bag_gra_bag_bg_s_NCGR, wk->bgl, GF_BGL_FRAME1_S, 0, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_PalSet(
		wk->gra_h, NARC_bag_gra_bag_bg_s_NCLR, PALTYPE_SUB_BG, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_ScrnSet(
		wk->gra_h, NARC_bag_gra_bag_bg_s0_NSCR,
		wk->bgl, GF_BGL_FRAME1_S, 0, 0, 0, HEAPID_BAG );

	ArcUtil_HDL_BgCharSet(
		wk->gra_h, NARC_bag_gra_bag_wheel_NCGR, wk->bgl, GF_BGL_FRAME3_S, 0, 0, 0, HEAPID_BAG );
	ArcUtil_HDL_ScrnSet(
	...
	ArcUtil_HDL_PalSet(
		wk->gra_h, NARC_bag_gra_bag_button_NCLR, PALTYPE_SUB_BG, 16*2*2, 0x20*2, HEAPID_BAG );
}
 ...
 *
 * @param	wk		バッグ画面のワーク
 * @param	mv_rot	ホイール一周で動く対象のカウント
 *
 * @retval	"TRUE = ホイールに触っている"
 * @retval	"FALSE = ホイールに触ってない"
 */
//--------------------------------------------------------------------------------------------
static BOOL BAG_WheelMove( BAG_WORK * wk, u16 mv_rot )
{
 ...
 * @param	prm		移動方向
 *
 * @retval	"TRUE = メニュー動作あり"
 * @retval	"FALSE = メニュー動作なし"
 */
//--------------------------------------------------------------------------------------------
static BOOL BAG_WheelMenuWrite( BAG_WORK * wk, u8 prm )
{
