...
//============================================================================================
// パレット定義
#define	SYS_FONT_PAL	( 3 )		// システムフォント
...
// 下画面のボタンデータ
#define	BUTTON_CGX_START	( 30 )		// 開始キャラ位置
#define	BUTTON_CGX_WIDE		( 30 )		// グラフィックデータの横幅（キャラ単位）
#define	BUTTON_CGX_XNEXT	( 15 )		// 次のボタンの開始X位置
#define	BUTTON_CGX_YNEXT	( 30 * 5 )	// 次のボタンの開始Y位置
#define	BUTTON_CGX_SIZE		( 5 )		// ボタンの一辺のサイズ
#define	BUTTON_PAL_NUM		( 2 )		// パレット
