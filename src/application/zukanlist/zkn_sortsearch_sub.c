...
typedef struct {
	...
	int type_page;			// タイプページ

	// ワークローカル今の選択タイプ
	int local_select;	
	int local_type_page;			// 反映チェック用タイプページ
	...
	// 処理実行データ
	int do_flag_common;		// 処理実行データ	押されたボタンナンバーを格納
	int do_flag_select;		// 処理実行データ押されたボタンナンバーを格納

	int type_set_no;		// 設定するタイプナンバー
 ...
 *	@param	p_glb		データグローバル
 *	@param	heap		ヒープ
 *	@param	select_type	選択タイプ
 *	@param	type_page	タイプページ
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
...
static void ZknSortSearchSubButtonCallBackSort( u32 button_no, u32 event, void* p_work )
{
	...
	case BMN_EVENT_HOLD:
		...
		ZKN_CURSOR_Cont( p_subwork->p_cursor, ZKN_CURSOR_CONT_SET_CONTID, ZKN_SORTSEARCHSUB_SURSOR_ID_OTHER_02+button_no );
 ...
 *	@param	p_work			ワークデータ
 *	@param	p_glb			グローバルデータ
 *	@param	select_type		セレクトタイプ
 *	@param	type_page		タイプのページ
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
/**
 *	@brief	セレクトタイプが変更されたので、セルアクターを変更
 *
 *	@param	p_draw		描画ワーク
 *	@param	p_drawglb	描画グローバル
 *	@param	heap		ヒープ
 ...
 *	@param	p_add		登録データ
 *	@param	select_type	セレクトタイプ
 *	@param	local_type_page	タイプのpage数
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
 ...
 *	@param	select_type		選択タイプ
 *	@param	local_type_page	タイプのページ数
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
 ...
 *
 *	@param	p_draw
 *	@param	p_fontoam_init	必須データ格納済み
 *
 *	@return	none
 */
//-----------------------------------------------------------------------------
