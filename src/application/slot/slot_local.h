...
#define REEL_PT_V_SIZE   (32)							// 絵柄サイズ ドット
#define REEL_PT_V_OFFSET (16)							// 絵柄オフセット

#define REEL_PT_V_MAX    (160)							// 絵柄縦最大
#define REEL_PT_V_DG(v)  ((v)/REEL_PT_V_SIZE)			// ドット -> グリッド
#define REEL_PT_V_DG32(v)  ((FX32_NUM(v))/REEL_PT_V_SIZE)// ドット -> グリッド fx32
#define REEL_PT_V_GD(v)  ((v)*REEL_PT_V_SIZE)			// グリッド -> ドット
#define REEL_PT_V_GD32(v)  (NUM_FX32((v)*REEL_PT_V_SIZE))	// グリッド -> ドット
#define REEL_SCROLL_MAX  (REEL_PT_MAX*REEL_PT_V_SIZE)	// リールスクロール最大
#define REEL_CENTERN_V   ((0x09*8)+4)					// リール中央

#define MCREEL_PT_MAX		(0x06)						// マシンリール絵柄最大
#define MCREEL_PT_V_SIZE	(0x14)						// マシンリール絵柄サイズ
#define MCREEL_PT_V_OFFSET	((0x06*0x08)+4+8)			// マシンリール絵柄オフセット
#define MCREEL_PT_V_MAX		(0x02*MCREEL_PT_V_SIZE)		// マシンリール縦最大
#define MCREEL_PT_V_GP(v)	((v)/MCREEL_PT_V_SIZE)		// 座標->グリッド
...
///	当たり
//--------------------------------------------------------------
#define BIT_CHERRY		0x0001							// ヒットフラグ
