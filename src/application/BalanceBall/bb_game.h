...
///< 玉の傾き更新タイミング ( 30フレ x 秒数 なので、30*2なら２秒に１回 )
#define BB_ROOL_UPDATE_LV1	( 30 * 4 )					///< 回転の更新フレーム
#define BB_ROOL_UPDATE_LV2	( 30 * 3 )					///< 回転の更新フレーム
#define BB_ROOL_UPDATE_LV3	( 30 * 2 )				///< 回転の更新フレーム
#define BB_ROOL_UPDATE_LV4	( 30 * 1.5 )					///< 回転の更新フレーム
...
#define BB_CONST_INI_FRAME	( 8 )						///< 一定量で動くフレーム
#define BB_CONST_ROLL_FRAME	( BB_CONST_INI_FRAME + 2 )	///< 一定量で動くフレーム
#define BB_ACCEL_ROLL_FRAME	( 12 )						///< 加速するフレーム
