...
extern void BattleParam_SetParamByGameDataCore(BATTLE_PARAM* bp, const FIELDSYS_WORK* fsys, SAVEDATA* savedata, int zone_id, FNOTE_DATA* fnote, BAG_CURSOR* bag_cursor, BATTLE_CURSOR_DISP* battle_cursor );
