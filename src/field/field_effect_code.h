...
enum
{
	...
	FE_BLACT_H_ID_KEMURI_L,					///<土煙 左
	FE_BLACT_H_ID_KEMURI_R,					///<土煙 右
	FE_BLACT_H_ID_KEMURI_U,					///<土煙 上
...
enum
{
	...
	FE_RESID_MDL_KEMURI_L,					///<土煙 左
	FE_RESID_MDL_KEMURI_R,					///<土煙 右
	FE_RESID_MDL_KEMURI_U,					///<土煙 上
};
