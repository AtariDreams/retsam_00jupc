...
extern EOA_PTR FE_FldOBJFootMarkShadowSnow_Add( CONST_FIELD_OBJ_PTR fldobj );
extern EOA_PTR FE_FldOBJFootMarkShadowSnowCycle_Add( CONST_FIELD_OBJ_PTR fldobj );
