...
static void CellActSet( _START_WORK * wk, u8 * list, u32 max )
{
	...
	hdl = ArchiveDataHandleOpen( ARC_MENU_GRA, HEAPID_WORLD );
	...
	FldClact_LoadResCellArcH(
		&wk->fcat, hdl, NARC_menu_gra_fmenu_cur_NCER, 0, FLDMENU_CLA_CEL_H_ID_CURSOR );

	FldClact_LoadResCellAnmArcH(
		&wk->fcat, hdl, NARC_menu_gra_fmenu_cur_NANR, 0, FLDMENU_CLA_ANM_H_ID_CURSOR );

	FldClact_LoadResourceCharArcH(
		&wk->fcat, hdl, NARC_menu_gra_fmenu_cur_NCGR,
	...
	FldClact_LoadResCellArcH(
		&wk->fcat, hdl, NARC_menu_gra_ugmenu_obj_NCER, 0, FLDMENU_CLA_CEL_H_ID_ICON );

	FldClact_LoadResCellAnmArcH(
		&wk->fcat, hdl, NARC_menu_gra_ugmenu_obj_NANR, 0, FLDMENU_CLA_ANM_H_ID_ICON );

	FldClact_LoadResourceCharArcH(
		&wk->fcat, hdl, NARC_menu_gra_ugmenu_obj_NCGR,
