...
///		OS_Printf("Map3DObjをクリアして、エディット用に再セット\n");
		...
		break;
   case BASE_SEQ_FADEIN:

        WIPE_SYS_Start(WIPE_PATTERN_FMAS,
                       WIPE_TYPE_PESOCOMIN,
                       WIPE_TYPE_PESOCOMIN, WIPE_FADE_BLACK,WIPE_DEF_DIV,
                       WIPE_DEF_SYNC,HEAPID_FIELD);

		SetNextSeqCall(BASE_SEQ_FADEINEND, ebew);

        break;
    case BASE_SEQ_FADEINEND:
...
///		OS_Printf("メニューウィンドウ\n");
	...
	case BASE_SEQ_END:
        ...
        WIPE_SYS_Start(WIPE_PATTERN_FSAM,
                       ...
                       WIPE_TYPE_PESOCOMOUT, WIPE_FADE_BLACK,WIPE_DEF_DIV,
                       WIPE_DEF_SYNC,HEAPID_FIELD);
				SetNextSeqCall(BASE_SEQ_END2, ebew);
