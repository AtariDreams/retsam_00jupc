...
GLOBAL FLDMAPFUNC_WORK* FLDMAP_Amaikaori_Komorebi_Start( FIELDSYS_WORK* fsys );
GLOBAL FLDMAPFUNC_WORK* FLDMAP_AmaikaoriEndEff_Komorebi_Start( FIELDSYS_WORK* fsys );
GLOBAL BOOL FLDMAP_Amaikaori_Komorebi_EndCheck( FLDMAPFUNC_WORK* p_eff );
