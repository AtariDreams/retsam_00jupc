...
GLOBAL void FldClact_LoadResPlttArcH(
...
GLOBAL void FldClact_LoadResCellArcH(
					FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int id );
...
GLOBAL void FldClact_LoadResCellAnmArc(
						FIELD_CLACT * fcat, int arc_id, int data_id, int comp, int id );
GLOBAL void FldClact_LoadResCellAnmArcH(
						FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int id );
...
GLOBAL void FldClact_LoadResourceCharArcH(
