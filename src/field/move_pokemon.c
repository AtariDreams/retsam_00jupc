...
#define MOVE_POKE_FAIYAA_LV		(60)
#define MOVE_POKE_SANDAA_LV		(60)
#define MOVE_POKE_HURIIZAA_LV	(60)
...
void MP_AddMovePoke(SAVEDATA *sv, const u8 inTargetPoke)
{
	...
	case MOVE_POKE_DAAKU:
		...
		break;
	case MOVE_POKE_FAIYAA:
		monsno = MONSNO_FAIYAA;
		lv = MOVE_POKE_FAIYAA_LV;
		break;
	case MOVE_POKE_SANDAA:
		monsno = MONSNO_SANDAA;
		lv = MOVE_POKE_SANDAA_LV;
		break;
	case MOVE_POKE_HURIIZAA:
		monsno = MONSNO_HURIIZAA;
		lv = MOVE_POKE_HURIIZAA_LV;
		break;
	default:
		GF_ASSERT(0);
		return ;
