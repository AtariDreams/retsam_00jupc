...
//--------------------------------------------------------------
/**
 * @brief   レギュレーションとファイトタイプから録画モードを取得する
 *
 * @param   reg				レギュレーションデータへのポインタ
 * @param   fight_type		ファイトタイプ
 *
 * @retval  録画モード
 *
 *
 */
//--------------------------------------------------------------
static int Regulation_RecMode_Get(const REGULATION *reg, int fight_type)
{
	int rec_mode, reg_no;
	
	reg_no = Data_GetRegulationNo(reg);
