...
//============================================================================================
BOOL SysFlag_BicycleGatePassage( EVENTWORK* ev, SYSFLAG_MODE mode )
{
	return SysFlag_Common( ev, mode, SYS_FLAG_BICYCLE_GATE );
}
 ...
 */
//--------------------------------------------------------------------------------------------
BOOL SysFlag_VillaFurniture( EVENTWORK* ev, SYSFLAG_MODE mode, int no )
{
	GF_ASSERT( no < VILLA_FTURE_MAX );
	return SysFlag_Common( ev, mode, SYS_FLAG_FURNITURE_01 + no );
}
 ...
 */
//--------------------------------------------------------------------------------------------
void SysFlag_T07ObjInReset( EVENTWORK* ev )
{
	SysFlag_Reset( ev, SYS_FLAG_T07_OBJ_IN );
	return;
}
 ...
 */
//--------------------------------------------------------------------------------------------
void SysFlag_T07R0201PosAppearReset( EVENTWORK* ev )
{
	SysFlag_Reset( ev, SYS_FLAG_T07R0201_POS_APPEAR );
	return;
}
 ...
 */
//--------------------------------------------------------------
BOOL SysFlag_TornWorldGirasFlag( EVENTWORK* ev, SYSFLAG_MODE mode, int no )
{
	return SysFlag_Common( ev, mode, SYS_FLAG_TW_GIRAS_0500 + no );
}
 ...
 */
//--------------------------------------------------------------
BOOL SysFlag_TornWorldRockFinish( EVENTWORK* ev, SYSFLAG_MODE mode )
{
	return SysFlag_Common( ev, mode, SYS_FLAG_TW_ROCK_FINISH );
}

//--------------------------------------------------------------
/**
 * 岩落とし完了後のリフト出現フラグチェック
 * @param	ev	EVENTWORKのポインタ
 * @retval	BOOL
 */
//--------------------------------------------------------------
BOOL SysFlag_TornWorldRockLiftFlagCheck( EVENTWORK* ev )
{
	return SysFlag_Common( ev, SYSFLAG_MODE_CHECK, SYS_FLAG_TW_ROCKLIFT_ON );
}
 ...
 */
//--------------------------------------------------------------
void SysFlag_TornWorldRockLiftFlagSet( EVENTWORK* ev )
{
	SysFlag_Common( ev, SYSFLAG_MODE_SET, SYS_FLAG_TW_ROCKLIFT_ON );
}
