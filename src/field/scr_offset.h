...
#define	ID_DOSA_OFFSET					(10400)		//ドサ周りスクリプトIDのオフセット
#define	ID_DOSA_OFFSET_END				(10449)		//ドサ周りスクリプトIDのオフセット終了
#define	ID_SEISEKI_OFFSET				(10450)		//フロンティア成績スクリプトIDのオフセット
#define	ID_SEISEKI_OFFSET_END			(10489)		//フロンティア成績スクリプトIDのオフセット終了
#define	ID_SCRATCH_OFFSET				(10490)		//スクラッチスクリプトIDのオフセット
#define	ID_SCRATCH_OFFSET_END			(10499)		//スクラッチスクリプトIDのオフセット終了
