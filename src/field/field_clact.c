...
static void CATS_LoadResourceCellArc_PrivateH(
				FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int type, int id );
 ...
 */
//--------------------------------------------------------------------------------------------
void FldClact_LoadResPlttArcH(
		FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int num, int trans_mode, int id )
{
	CLACT_U_RES_OBJ_PTR obj;
	int ret;
	...
	obj = CLACT_U_ResManagerResAddArcPltt_ArcHandle(
				fcat->resMan[1], p_handle, data_id, comp, id, trans_mode, num, fcat->heap );
...
void FldClact_LoadResCellArcH( FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int id )
{
	CATS_LoadResourceCellArc_PrivateH( fcat, p_handle, data_id, comp, 2, id );
}
...
void FldClact_LoadResCellAnmArcH( FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int id )
{
	CATS_LoadResourceCellArc_PrivateH( fcat, p_handle, data_id, comp, 3, id );
}
...
void FldClact_LoadResourceCharArcH(
		FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, BOOL comp, int trans_mode, int id )
{
	CLACT_U_RES_OBJ_PTR obj;
	...
	obj = CLACT_U_ResManagerResAddArcChar_ArcHandle(
			fcat->resMan[0], p_handle, data_id, comp, id, trans_mode, fcat->heap );
				...
				FIELD_CLACT * fcat, ARCHANDLE* p_handle, int data_id, int comp, int type, int id )
{
	...
	obj = CLACT_U_ResManagerResAddArcKindCell_ArcHandle(
				fcat->resMan[type], p_handle, data_id, comp, id, type, fcat->heap );
