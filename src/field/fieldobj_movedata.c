...
extern int (* const DATA_AC_WalkGUU4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUD4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUL4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUR4F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUU2F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUD2F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUL2F_Tbl[])( FIELD_OBJ_PTR );
extern int (* const DATA_AC_WalkGUR2F_Tbl[])( FIELD_OBJ_PTR );
...
{
	MV_RND,													///<動作コード
	FieldOBJ_MoveRndHLim_Init,								///<初期化関数
	FieldOBJ_MvRnd_Move,									///<動作関数
	FieldOBJ_MoveDeleteProcDummy,							///<削除関数
	FieldOBJ_MoveReturnProcDummy,							///<復帰関数
};
