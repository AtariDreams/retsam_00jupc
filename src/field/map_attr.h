...
extern BOOL MATR_IsJumpUp2G(MATR matr);
extern BOOL MATR_IsJumpDown2G(MATR matr);
extern BOOL MATR_IsJumpLeft2G(MATR matr);
extern BOOL MATR_IsJumpRight2G(MATR matr);
...
extern MATR MATR_IsNotAttrGet(void);
extern BOOL MATR_IsMirrorReflect(MATR matr);
extern BOOL MATR_IsShadowOnSnow(MATR matr);
extern BOOL MATR_IsTankenBan(MATR matr);
