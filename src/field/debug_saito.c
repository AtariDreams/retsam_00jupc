...
static const ID_PARAM DebugMovePokeNameList[] = {
	...
	{ D_SAITO_MP_FAIYAA, (u32)SetupMovePokeZoneChgWin },
	{ D_SAITO_MP_SANDAA, (u32)SetupMovePokeZoneChgWin },
	{ D_SAITO_MP_HURIIZAA, (u32)SetupMovePokeZoneChgWin },
};
...
static void DrawMovePokeInfo(DEBUG_WORK_DATA *d_work)
{
	...
	int poke_name_list[MOVE_POKE_MAX] = {
		D_SAITO_MP_AI, D_SAITO_MP_MUUBASU, D_SAITO_MP_DAAKU, 
		D_SAITO_MP_FAIYAA, D_SAITO_MP_SANDAA, D_SAITO_MP_HURIIZAA,
	};
