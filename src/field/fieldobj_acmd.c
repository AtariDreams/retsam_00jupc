...
static void AcMarkWorkInit(
	FIELD_OBJ_PTR fldobj, GYOE_TYPE type, int trans );
...
static void AcJumpWorkInitMain(
	FIELD_OBJ_PTR fldobj, int dir, fx32 val,
...
{
	AcJumpWorkInitMain( fldobj, dir, val,
 ...
 */
//--------------------------------------------------------------
static int AC_JumpU3G24F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpWorkInitMain( fldobj, DIR_UP, GRID_VALUE_SPEED_8,
 ...
 */
//--------------------------------------------------------------
static int AC_JumpD3G24F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpWorkInitMain( fldobj, DIR_DOWN, GRID_VALUE_SPEED_8,
		GRID_FRAME_8*3, DRAW_STA_WALK_8F, AC_JUMP_HEIGHT_12,
		AC_JUMP_SPEED_UX16_TBL(24), SE_TWORLD_JUMP );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpL3G24F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpWorkInitMain( fldobj, DIR_LEFT, GRID_VALUE_SPEED_8,
		GRID_FRAME_8*3, DRAW_STA_WALK_8F, AC_JUMP_HEIGHT_12,
		AC_JUMP_SPEED_UX16_TBL(24), SE_TWORLD_JUMP );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpR3G24F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpWorkInitMain( fldobj, DIR_RIGHT, GRID_VALUE_SPEED_8,
		GRID_FRAME_8*3, DRAW_STA_WALK_8F, AC_JUMP_HEIGHT_12,
		AC_JUMP_SPEED_UX16_TBL(24), SE_TWORLD_JUMP );
	...
	FIELD_OBJ_PTR fldobj, GYOE_TYPE type, int trans )
{
	...
	work->type = type;
	work->eoa_mark = FE_FldOBJGyoe_Add( fldobj, type, TRUE, trans );
	FieldOBJ_AcmdSeqInc( fldobj );
}
...
{
	AcMarkWorkInit( fldobj, GYOE_GYOE, FALSE );
	return( FALSE );
}
...
{
	AcMarkWorkInit( fldobj, GYOE_SAISEN, FALSE );
	return( FALSE );
}
 ...
 */
//--------------------------------------------------------------
static int AC_MarkGyoeTWait_0( FIELD_OBJ_PTR fldobj )
{
	AcMarkWorkInit( fldobj, GYOE_GYOE, TRUE );
	return( FALSE );
}
 ...
 */
//--------------------------------------------------------------
static void AcWalkVecWorkInit( FIELD_OBJ_PTR fldobj,
	const VecFx32 *vec, int d_dir, int m_dir, int wait, u8 draw )
{
	AC_WALKVEC_WORK *work;
	work = FieldOBJ_MoveCmdWorkInit( fldobj, AC_WALKVEC_WORK_SIZE );
	work->wait = wait;
	work->vec = *vec;
	
	FieldOBJ_DirDispCheckSet( fldobj, d_dir );
	FieldOBJ_DirMoveSet( fldobj, m_dir );
	FieldOBJ_DrawStatusSet( fldobj, draw );
	...
	if( vec->x < 0 ){ FieldOBJ_NowPosGX_Add( fldobj, -GRID_ONE ); }
	else if( vec->x > 0 ){ FieldOBJ_NowPosGX_Add( fldobj, GRID_ONE ); }
	if( vec->y < 0 ){ FieldOBJ_NowPosGY_Add( fldobj, -H_GRID_ONE*2 ); }
	else if( vec->y > 0 ){ FieldOBJ_NowPosGY_Add( fldobj, H_GRID_ONE*2 ); }
	if( vec->z < 0 ){ FieldOBJ_NowPosGZ_Add( fldobj, -GRID_ONE ); }
	else if( vec->z > 0 ){ FieldOBJ_NowPosGZ_Add( fldobj, GRID_ONE ); }
 ...
 */
//--------------------------------------------------------------
static int AC_WalkVec_1( FIELD_OBJ_PTR fldobj )
{
	AC_WALKVEC_WORK *work;
	
	work = FieldOBJ_MoveCmdWorkGet( fldobj );
	FieldOBJ_VecPosAdd( fldobj, &work->vec );
	...
	FieldOBJ_StatusBit_ON(
		fldobj, FLDOBJ_STA_BIT_MOVE_END|FLDOBJ_STA_BIT_ACMD_END );
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGLU8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, GRID_VALUE_SPEED_8, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGLD8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, -GRID_VALUE_SPEED_8, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGLL8F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGLR8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_8 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGRU8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, GRID_VALUE_SPEED_8, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGRD8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, -GRID_VALUE_SPEED_8, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGRL8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_8 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGRR8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, GRID_VALUE_SPEED_8 };
	AcWalkVecWorkInit( fldobj, &vec,
		DIR_DOWN, DIR_LEFT, GRID_FRAME_8, DRAW_STA_WALK_8F );
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUU8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, GRID_VALUE_SPEED_8 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUD8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_8 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUL8F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUR8F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { GRID_VALUE_SPEED_8, 0, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUU4F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUD4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUL4F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUR4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { GRID_VALUE_SPEED_4, 0, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUU2F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUD2F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_2 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUL2F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_WalkGUR2F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { GRID_VALUE_SPEED_2, 0, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGLU4F_0( FIELD_OBJ_PTR fldobj )
{
 ...
 */
//--------------------------------------------------------------
static int AC_DashGLD4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, -GRID_VALUE_SPEED_4, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGLL4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGLR4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGRU4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, GRID_VALUE_SPEED_4, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGRD4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, -GRID_VALUE_SPEED_4, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGRL4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGRR4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
		DIR_DOWN, DIR_LEFT, GRID_FRAME_4, DRAW_STA_DASH_4F );
 ...
 */
//--------------------------------------------------------------
static int AC_DashGUU4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGUD4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { 0, 0, -GRID_VALUE_SPEED_4 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGUL4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { -GRID_VALUE_SPEED_4, 0, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static int AC_DashGUR4F_0( FIELD_OBJ_PTR fldobj )
{
	VecFx32 vec = { GRID_VALUE_SPEED_4, 0, 0 };
	AcWalkVecWorkInit( fldobj, &vec,
 ...
 */
//--------------------------------------------------------------
static void AcJumpVecWorkInit( FIELD_OBJ_PTR fldobj,
	fx32 val, int d_dir, int m_dir, u8 wait, u8 draw,
	u8 vec_type, u8 jump_vec_type, u8 jump_flip )
{
	int grid = GRID_ONE;
	AC_JUMPVEC_WORK *work;
	work = FieldOBJ_MoveCmdWorkInit( fldobj, AC_JUMPVEC_WORK_SIZE );
	...
	if( val ){		//移動量が存在する
		...
		case VEC_X:
			if( val < 0 ){ grid = -grid; }
			FieldOBJ_NowPosGX_Add( fldobj, grid );
			break;
		case VEC_Y:
			if( val < 0 ){ grid = -grid; }
			FieldOBJ_NowPosGY_Add( fldobj, grid*2 );
			break;
		case VEC_Z:
			if( val < 0 ){ grid = -grid; }
			FieldOBJ_NowPosGZ_Add( fldobj, grid );
			break;
		}
	}
 ...
 */
//--------------------------------------------------------------
static int AC_JumpVec_1( FIELD_OBJ_PTR fldobj )
{
	fx32 val;
	VecFx32 pos;
	AC_JUMPVEC_WORK *work;
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGLU1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_LEFT,DIR_UP, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Y, VEC_Y, FALSE );
	return( TRUE );
}
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGLD1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_RIGHT,DIR_DOWN, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Y, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGLL1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_DOWN,DIR_LEFT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGLR1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_UP,DIR_RIGHT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGRU1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_RIGHT,DIR_UP, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Y, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGRD1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_LEFT,DIR_DOWN, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Y, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGRL1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_UP,DIR_LEFT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGRR1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_DOWN,DIR_LEFT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGUU1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_DOWN,DIR_UP, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGUD1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_UP,DIR_DOWN, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_Z, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGUL1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, -GRID_VALUE_SPEED_8,
		DIR_RIGHT,DIR_LEFT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_X, VEC_Y, FALSE );
 ...
 */
//--------------------------------------------------------------
static int AC_JumpGUR1G_8F_0( FIELD_OBJ_PTR fldobj )
{
	AcJumpVecWorkInit( fldobj, GRID_VALUE_SPEED_8,
		DIR_LEFT,DIR_RIGHT, GRID_FRAME_8, DRAW_STA_WALK_8F,
		VEC_X, VEC_Y, FALSE );
...
///	AC_WALKGL_U_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGLU8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGLU8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGL_D_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGLD8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGLD8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGL_L_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGLL8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGLL8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGL_R_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGLR8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGLR8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGR_U_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGRU8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGRU8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGL_D_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGRD8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGRD8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGR_L_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGRL8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGRL8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGR_R_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGRR8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGRR8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_U_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUU8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUU8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_D_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUD8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUD8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_L_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUL8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUL8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_R_8F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUR8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUR8F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_U_4F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUU4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUU4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_D_4F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUD4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUD4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_L_4F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUL4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUL4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_R_4F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUR4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUR4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_U_2F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUU2F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUU2F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_D_2F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUD2F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUD2F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_L_2F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUL2F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUL2F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_WALKGU_R_2F
//--------------------------------------------------------------
int (* const DATA_AC_WalkGUR2F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_WalkGUR2F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_JUMP_U_3G_24F
//--------------------------------------------------------------
int (* const DATA_AC_JumpU_3G_24F_Tbl[])( FIELD_OBJ_PTR  ) =
{
	AC_JumpU3G24F_0,
	AC_Jump_1,
	AC_End,
...
///	AC_JUMP_D_3G_24F
//--------------------------------------------------------------
int (* const DATA_AC_JumpD_3G_24F_Tbl[])( FIELD_OBJ_PTR  ) =
{
	AC_JumpD3G24F_0,
	AC_Jump_1,
	AC_End,
...
///	AC_JUMP_L_3G_24F
//--------------------------------------------------------------
int (* const DATA_AC_JumpL_3G_24F_Tbl[])( FIELD_OBJ_PTR  ) =
{
	AC_JumpL3G24F_0,
	AC_Jump_1,
	AC_End,
...
///	AC_JUMP_R_3G_24F
//--------------------------------------------------------------
int (* const DATA_AC_JumpR_3G_24F_Tbl[])( FIELD_OBJ_PTR  ) =
{
	AC_JumpR3G24F_0,
	AC_Jump_1,
	AC_End,
...
///	AC_DASHGL_U_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGLU4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGLU4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGL_D_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGLD4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGLD4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGL_L_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGLL4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGLL4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGL_R_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGLR4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGLR4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGR_U_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGRU4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGRU4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGL_D_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGRD4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGRD4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGR_L_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGRL4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGRL4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGR_R_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGRR4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGRR4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGU_U_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGUU4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGUU4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGU_D_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGUD4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGUD4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGU_L_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGUL4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGUL4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_DASHGU_R_4F
//--------------------------------------------------------------
int (* const DATA_AC_DashGUR4F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_DashGUR4F_0,
	AC_WalkVec_1,
	AC_End,
...
///	AC_JUMPGL_U_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGLU1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGLU1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGL_D_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGLD1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGLD1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGL_L_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGLL1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGLL1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGL_R_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGLR1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGLR1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGR_U_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGRU1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGRU1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGL_D_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGRD1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGRD1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGR_L_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGRL1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGRL1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGR_R_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGRR1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGRR1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGU_U_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGUU1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGUU1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGU_D_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGUD1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGUD1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGU_L_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGUL1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGUL1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_JUMPGU_R_1G_8F
//--------------------------------------------------------------
int (* const DATA_AC_JumpGUR1G_8F_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_JumpGUR1G_8F_0,
	AC_JumpVec_1,
	AC_End,
...
///	AC_MARK_GYOE_TWAIT 0
//--------------------------------------------------------------
int (* const DATA_AC_MarkGyoeTWait_Tbl[])( FIELD_OBJ_PTR ) =
{
	AC_MarkGyoeTWait_0,
	AC_Mark_1,
	AC_End,
