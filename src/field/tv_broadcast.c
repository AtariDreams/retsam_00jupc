 ...
 *
 * topic_typeが１バイト、topic_id１バイトがPROG_TOPIC_MAX個の合計12バイトで構成されています。
 * 12バイトｘ9番組＝108バイトのバイナリデータから取得しています。★
 */
//--------------------------------------------------------------------
 ...
 *
 * コンバート元データの含まれるトピックIDの最後に0を入れないといけない！
 * ↓処理がトピックIDが0がくるまでとしているので。
