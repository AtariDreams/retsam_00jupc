...
#define JIKI_MOVE_HIT_BIT_JUMP_3G	(1<<7)					///<3Gジャンプ
...
extern PLAYER_STATE_PTR Player_Init( CONST_FIELD_OBJ_SYS_PTR fos,
	int x, int z, int dir, int form, int sex,
	HEROVER ver, PLAYER_SAVE_DATA *save );
extern PLAYER_STATE_PTR Player_FieldOBJUseRecover(
	CONST_FIELD_OBJ_SYS_PTR fos, PLAYER_SAVE_DATA *save, int sex );
extern void Player_DrawInit( PLAYER_STATE_PTR jiki, int g_id );
...
extern int Player_TwThinkDirGet( const PLAYER_STATE_PTR jiki );
...
extern void Player_AcmdTypeSet( PLAYER_STATE_PTR jiki, HEROACTYPE type );
extern HEROACTYPE Player_AcmdTypeGet( PLAYER_STATE_PTR jiki );
extern void Player_AcmdCodeTypeSet( PLAYER_STATE_PTR jiki, u32 ac, HEROACTYPE type );
...
extern void Player_MoveBitSet_TWorld(
		PLAYER_STATE_PTR jiki, HEROTWTYPE type );
extern HEROTWTYPE Player_MoveBitCheck_TWorld( CONST_PLAYER_STATE_PTR jiki );
extern BOOL Player_MoveBitCheck_TWorldSp( CONST_PLAYER_STATE_PTR jiki );
extern BOOL Player_MoveBitCheck_Flat( CONST_PLAYER_STATE_PTR jiki );
...
extern u32 Player_TwMoveHitCheck(
...
extern void Player_AcmdSet( PLAYER_STATE_PTR jiki, u32 ac, HEROACTYPE type );
...
extern void Player_TwThinkDirPosGet(
...
extern u32 Player_TwThinkAttrGet( PLAYER_STATE_PTR jiki, int gx, int gy, int gz );
extern u32 Player_TwThinkNextDirAttrGet( PLAYER_STATE_PTR jiki, int dir );
extern u32 Player_TwThinkNowAttrGet( PLAYER_STATE_PTR jiki );
extern void Player_TwThinkFrontPosGet(
...
extern TCB_PTR Player_BSDrawProcSet( FIELDSYS_WORK *fsys );
extern void Player_BSDrawProcDelete( TCB_PTR tcb );
