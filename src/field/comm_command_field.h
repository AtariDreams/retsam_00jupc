...
enum CommCommandField_e {
  ...
  CG_GURU2_CMD,								///< ぐるぐる交換
  CG_GURU2_EGG,								///< ぐるぐる交換たまご
  
  //------------------------------------------------ここまで

  //------------------------------------------------ここからフロンティアフィールド専用通信コマンド
  
  //FC_FLD_STAGE_MONSNO,//ステージ(フィールド)
  //FC_FLD_CASTLE_MONSNO,//キャッスル(フィールド)
  //FC_FLD_ROULETTE_MONSNO,//ルーレット(フィールド)
  CF_STAGE_MONSNO,							//ステージ(フィールド)
  CF_CASTLE_MONSNO,							//キャッスル(フィールド)
  CF_ROULETTE_MONSNO,						//ルーレット(フィールド)
