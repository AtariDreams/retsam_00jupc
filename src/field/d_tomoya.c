...
static void StartWFLBYROOM_LockLong_Check( TCB_PTR tcb, void* work );
...
//=============================================================================
#ifdef D_TOMOYA_MATERIAL_ON
	#define MAP_TYPE_LIST_COUNT_MAIN	(20)
#else
...
static const BMPLIST_DATA MainDebugList[] = {
	...
	{(void*)Msg01_34,(u32)StartWFLBYROOM_LockLong_Check},
 ...
 */
//-----------------------------------------------------------------------------
#define D_TOMO_POISON_COUNT		( 8 )		// 動作カウンタ
#define D_TOMO_POISON_NEXT		( 64 )		// 次動作までのカウンタ
#define D_TOMO_POISON_NEXT_WALK		( 4 )		// 次動作までのカウンタ
...
static void StartWFLBYROOM_Check( TCB_PTR tcb, void* work )
{
	...
	p_pearent->p_wflby_counter	= &D_TomoyaFldSys->wflby_counter;
	DT_sprite->p_pearent = p_pearent;
	DT_sprite->p_fsys = D_TomoyaFldSys;
...
static void StartWFLBYROOM0_Check( TCB_PTR tcb, void* work )
{
	D_Tomoya_WiFiLobby_ChannelPrefix	= PPW_LOBBY_CHANNEL_PREFIX_RELEASE;
...
static void StartWFLBYROOM_Check_End( DT_SPRITE_CHECK* data )
{
	...
	D_Tomoya_WiFiLobby_ChannelPrefixFlag= FALSE;
	D_Tomoya_WiFiLobby_ChannelPrefix	= PPW_LOBBY_CHANNEL_PREFIX_RELEASE;
	D_Tomoya_WiFiLobby_ALLVip = FALSE;
	D_Tomoya_WiFiLobby_LockTime_Long	= FALSE;
	sys_FreeMemoryEz( data->p_pearent );
}
