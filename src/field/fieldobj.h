...
#define FLDOBJ_FRAME_TRANS_MAX (10)	//1Frameに転送できるデータ数最大
...
extern const int DATA_FieldOBJ_BlActFogEnableOFFTbl[];
...
//	fieldobj_blact.c
//--------------------------------------------------------------
extern void FieldOBJ_BlActCont_Init(
...
extern BLACT_WORK_PTR FieldOBJ_BlActDummyDrawReset(
...
extern void FieldOBJ_DrawInitAfterMoveProcCall( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_MoveRndHLim_Init( FIELD_OBJ_PTR fldobj );
...
extern void FieldOBJ_DrawBlActBldAgunomu_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActBldAgunomu_Delete( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActBldAgunomu_Push( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActBldAgunomu_Pop( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActAgunomu_Draw( FIELD_OBJ_PTR fldobj );

extern void FieldOBJ_DrawBlActTw7SpPoke_Init( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActTw7SpPoke_Delete( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActTw7SpPoke_Push( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActTw7SpPoke_Pop( FIELD_OBJ_PTR fldobj );
extern void FieldOBJ_DrawBlActTw7SpPoke_Draw( FIELD_OBJ_PTR fldobj );
...
extern BLACT_WORK_PTR FieldOBJ_SeedBlActPtrGet( FIELD_OBJ_PTR fldobj );
