...
#define BTLPOINT_VAL_TOWER_WIFI1	(3)			//ダウンロード
...
#define BTLPOINT_VAL_TOWER_STAGE1	(3)			//シングル、ダブル、AIマルチ
...
#define BTLPOINT_VAL_TOWER_STAGE7	(7)			//ここはプログラム的にDPからまちがっているため。
#define BTLPOINT_VAL_TOWER_STAGE8	(7)
#define BTLPOINT_VAL_TOWER_COMM1	(8)			//マルチ、WIFI
#define BTLPOINT_VAL_TOWER_COMM2	(9)
#define BTLPOINT_VAL_TOWER_COMM3	(11)
#define BTLPOINT_VAL_TOWER_COMM4	(12)
#define BTLPOINT_VAL_TOWER_COMM5	(14)
#define BTLPOINT_VAL_TOWER_COMM6	(15)
...
#define BTWR_SUB_RECV_BUF_CLEAR			(BTWR_SUB_START+28)
#define BTWR_SUB_SET_FIRST_BTL_FLAG		(BTWR_SUB_START+29)
