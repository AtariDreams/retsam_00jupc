...
#else
	//プラチナで使えるゾーンが増えました(08.06.06)
	if( (zone_id == ZONE_ID_D05R0114) ||
		(zone_id == ZONE_ID_D05R0118) ||
		(zone_id == ZONE_ID_D05R0119) ){
		return TRUE;
	}
...
int ZoneData_GetShinkaPlaceID(int zone_id)
{
	static const u16 tbl[] = {
		...
		ZONE_ID_D05R0116,	SHINKA_PLACE_TENGANZAN,				//PL
		ZONE_ID_D05R0117,	SHINKA_PLACE_TENGANZAN,				//PL
		ZONE_ID_D05R0118,	SHINKA_PLACE_TENGANZAN,				//PL
		ZONE_ID_D05R0119,	SHINKA_PLACE_TENGANZAN,				//PL
	};
	int i;
