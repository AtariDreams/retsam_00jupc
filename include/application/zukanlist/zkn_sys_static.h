...
GLOBAL u32 ZKN_UTIL_PokemonGraphicSet_Sheimi_Idx( ZKN_GLB_DRAWDATA* p_draw, const ZKN_GLB_DATA* cp_glb, int dir, int x, int y, int count, int idx );
GLOBAL u32 ZKN_UTIL_PokemonGraphicSet_Giratyina_Idx( ZKN_GLB_DRAWDATA* p_draw, const ZKN_GLB_DATA* cp_glb, int dir, int x, int y, int count, int idx );
GLOBAL u32 ZKN_UTIL_PokemonGraphicSet_Rotom_Idx( ZKN_GLB_DRAWDATA* p_draw, const ZKN_GLB_DATA* cp_glb, int dir, int x, int y, int count, int idx );



//-------------------------------------
//	ポケモン図鑑メッセージデータSTRBUF取得
//=====================================
