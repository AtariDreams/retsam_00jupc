...
#define IMC_RBOX_BG_PLTT_OFFS	(13)		// パレット番号
...
GLOBAL void IMC_RBOX_AddPoke_Contest( IMC_RIGHT_BOX* rbox, POKEMON_PARAM* poke_para, SOFT_SPRITE_ARC* arc_data, int heap );
