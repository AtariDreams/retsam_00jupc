...
GLOBAL void IMC_POKE_InitEx( IMC_POKE* poke,  SOFT_SPRITE_MANAGER* sprite_man, POKEMON_PARAM* poke_para, SOFT_SPRITE_ARC* arc_data, int heap, BOOL contest );
...
//-----------------------------------------------------------------------------
#if PLFIX_S2407
GLOBAL void IMC_POKE_InSizeGet( IMC_POKE* poke, IMC_POKE_RECT* p_rect );
#else
