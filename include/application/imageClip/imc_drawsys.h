...
typedef struct {
	...
	NNSGfdTexKey	SSM_texKey;				// ポケモンのTEXKEY
	NNSGfdPlttKey	SSM_plttKey;			// ポケモンのPLTTKEY
	...
	// アーカイブデータ
	ARCHANDLE* p_handle;	// クリップ用グラフィックのハンドル
} IMC_DRAW_DATA;
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void IMC_DRAW_CLACT_LoadCharData( IMC_DRAW_DATA* drawData, ARCHANDLE* p_handle, int dataIdx, BOOL comp, int vramType, int id );
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void IMC_DRAW_CLACT_LoadPlttData( IMC_DRAW_DATA* drawData, ARCHANDLE* p_handle, int dataIdx, BOOL comp, int vramType, int load_num, int id );
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void IMC_DRAW_CLACT_LoadCellData( IMC_DRAW_DATA* drawData, ARCHANDLE* p_handle, int dataIdx, BOOL comp, int id );
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void IMC_DRAW_CLACT_LoadCellAnmData( IMC_DRAW_DATA* drawData, ARCHANDLE* p_handle, int dataIdx, BOOL comp, int id );
