...
///////////////////////////////////////////////////////////////////////////////
enum{
	CLACT_U_EASYRENDER_SURFACE_MAIN,	// メインサーフェース
	CLACT_U_EASYRENDER_SURFACE_SUB,		// サブサーフェース
...
typedef struct{
	...
	NNSG2dRenderSurface		surface[CLACT_U_EASYRENDER_SURFACE_NUM];	// サーフェース
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void CLACT_U_GetMainSurfaceData( CLACT_U_EASYRENDER_DATA* data, NNSG2dViewRect* pRect );
 ...
 */
//-----------------------------------------------------------------------------
GLOBAL void CLACT_U_GetSubSurfaceData( CLACT_U_EASYRENDER_DATA* data, NNSG2dViewRect* pRect );
