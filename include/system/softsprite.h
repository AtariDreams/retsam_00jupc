...
///<SS_PARA_SHADOW_SIZE定義
#define	SS_SHADOW_NONE		(0)		///<影なし
#define	SS_SHADOW_SMALL		(0)		///<影小
#define	SS_SHADOW_MEDIUM	(0)		///<影中
#define	SS_SHADOW_LARGE		(0)		///<影大
...
extern void			SoftSpriteChrMask_DP(u8 *src);
extern void			SoftSpriteChrMask_ArcID(u8 *src, int arc_id);
