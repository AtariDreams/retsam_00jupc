...
//-------------------------------------
///	CALCTOOL変更定義
#define CALCTOOL_SINCOSTBLDEL	(1)	// サインコサインテーブル破棄
 ...
 */
 ...
 #define _Sin360( a ) (Sin360(a))
 #define _Cos360( a ) (Cos360(a))
 #define _RotKey( a ) (RotKey(a))
#else
...
GLOBAL void	CalcTool_Coded(void *data,u32 size,u32 code);
GLOBAL void	CalcTool_Decoded(void *data,u32 size,u32 code);
