...
extern GF_DATE  WorldTradeData_GetLastDate_Deposit( WORLDTRADE_DATA* WorldTradeData );
extern void  WorldTradeData_SetLastDate_Deposit( WORLDTRADE_DATA* WorldTradeData, GF_DATE date );
extern GF_DATE  WorldTradeData_GetLastDate_Search( WORLDTRADE_DATA* WorldTradeData );
extern void  WorldTradeData_SetLastDate_Search( WORLDTRADE_DATA* WorldTradeData, GF_DATE date );
