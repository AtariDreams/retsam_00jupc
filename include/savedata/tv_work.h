...
extern TOPICTEMP_STAGE * TVWORK_GetStageTemp(TV_WORK * tvwk);
extern TOPICTEMP_FRIEND * TVWORK_GetFriendTemp(TV_WORK * tvwk);
extern TOPICTEMP_BP * TVWORK_GetBPTemp(TV_WORK * tvwk);
extern TOPICTEMP_GTS * TVWORK_GetGTSTemp(TV_WORK * tvwk);
...
extern SEND_TOPIC * TVWORK_AllocSendQandADataEx(SAVEDATA * sv, int headID, u32 size);
extern SEND_TOPIC * TVWORK_AllocSendWatchDataEx(SAVEDATA * sv, int headID, u32 size);
extern SEND_TOPIC * TVWORK_AllocSendRecordDataEx(SAVEDATA * sv, int headID, u32 size);

extern void TVWORK_MixWatchData(TV_WORK * tv, int member, int my_id, const void ** darray, const void ** dp_darray);
extern void TVWORK_MixRecordData(TV_WORK * tv, int member, int my_id, const void ** darray, const void ** dp_darray);
