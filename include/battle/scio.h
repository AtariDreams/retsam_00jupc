...
#define	REC_DATA_SEND_SIZE	(28)	//対戦録画データ送信バッファサイズ
...
//ENCOUNT_EFFECT用
typedef struct{
	int	command_code;		//命令コードインデックス
	u32	rand_temp;			//ランダムの種テンポラリ
...
extern	BOOL	SCIO_CommRecvData(BATTLE_WORK *bw,void *data);
