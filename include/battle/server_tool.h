...
extern	BOOL	ST_ServerTenkiyaCheck(BATTLE_WORK *bw,SERVER_PARAM *sp,int *seq_no);
...
extern	BOOL	ST_YubiwohuruNGCheck(BATTLE_WORK *bw,SERVER_PARAM *sp,int client_no,u16 waza_no);
