...
extern	u8					BattleWorkEscCanCheck(BATTLE_WORK *bw,int client_no,u8 no_reshuffle_client);
...
extern	u32					BattleWorkRandTempGet(BATTLE_WORK *bw);
extern	void				BattleWorkRandTempSet(BATTLE_WORK *bw,u32 rand);
...
extern	BOOL				BattleWorkBattlePlay(BATTLE_WORK *bw,int client_no,REC_DATA *data);
...
extern	BOOL				BattleWorkBattleRecStopFlagCheck(BATTLE_WORK *bw);
