/*---------------------------------------------------------------------------*
  ...
  small fix about OS_Terminate() declaration in SDK_FINALROM.
  ...
  OS_PutChar を切り替え可能にする

  Revision 1.4  2003/11/25 00:05:04  yasu
  OS_VPrintf 公開に伴なう include ファイルの追加

  Revision 1.3  2003/11/21 12:21:10  yada
  REG_EMU_CONSOLE_OUT, reg_OS_EMU_CONSOLE_OUT を追加。
...
#include <stdio.h>                     // stdio.h での PADDING 警告を止める
