/*---------------------------------------------------------------------------*
  ...
  $Log: env_system.h,v $
  Revision 1.15  2005/10/13 00:23:42  kitase_hirotake
  add ENV_SetResoruceSetArray

  Revision 1.14  2005/08/31 09:44:17  yada
  applied for multi env array

  Revision 1.13  2005/08/23 07:04:11  yada
  add ENV_SearchByPartialName()

  Revision 1.12  2005/08/23 01:27:46  yada
  rename ENV_GetBinaryAndLength() to ENV_GetBinaryAndSize()

  Revision 1.11  2005/08/22 12:05:26  yada
  consider for const

  Revision 1.10  2005/08/22 11:54:27  yada
  change get string / binary function

  Revision 1.9  2005/08/22 11:36:11  yada
  change get function

  Revision 1.8  2005/08/22 05:23:47  yada
  ...
  Revision 1.5  2005/08/18 08:24:38  yada
  add ENV_InitIter(), ENV_SearchByClass(), ENV_SearchByMember()

  Revision 1.4  2005/08/18 04:27:44  yada
  just fix comment

  Revision 1.3  2005/08/17 11:17:46  yada
  fix a little

  Revision 1.2  2005/08/17 10:57:12  yada
  add ENV_GetU64() / S64()
