/*---------------------------------------------------------------------------*
  ...
  File:     ./build/lobby/include/dwci_nonportLinux.h
...
#ifndef DWCi_NONPORT_LINUX_H_
#define DWCi_NONPORT_LINUX_H_
...
inline s64 DWCi_Np_GetCurrentSecondByUTC()
{
    ...
    //DWC_Printf(DWC_REPORTFLAG_INFO, "DWCi_Np_GetCurrentSecondByUTC now %lld.\n", (s64)now);
    return (s64)now;
}
